    ...
    <div className="min-h-screen py-2">
      ...
      <main className="py-8">
        <div className="bg-gray-100 dark:bg-gray-700 w-1/3 shadow hover:shadow-xl border-l-4 hover:border-indigo-600 border-gray-600 rounded py-2 px-3 mx-auto space-y-4 duration-150">
          ...
          <button className="inline-flex items-center text-white text-sm bg-indigo-600 border-0 py-2 px-3 focus:outline-none hover:bg-indigo-500 rounded mt-4 md:mt-0 duration-300">
            Buy
            <svg
              fill="none"
              stroke="currentColor"
